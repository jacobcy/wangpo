            ...
            return {
                ...
                photos: function (data) {
                    if (angular.isDefined(data)) {
                        var pics = new String;
                        for (var i in data) {
                            var pic = '<div class="col-md-3"><img src="' + data[i].image + '" class="user-photo" /></div>';
                            pics = pics + pic;
                        }
                ...
                button: function (data, type, full, meta) {
                    var editButton = '<button class="btn btn-info" ng-click="user.edit(' + data + ')">' +
                        ...
                        '</button>&nbsp;';
                    var lockButton = '<button class="btn btn-success" ng-click="user.lock(' + data + ')">' +
                        '   <i class="fa fa-eye"></i>' +
                        '</button>';
                    var unlockButton = '<button class="btn btn-warning" ng-click="user.unlock(' + data + ')">' +
